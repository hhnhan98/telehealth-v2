...
export default function DoctorAppointmentDetail() {
  ...
  useEffect(() => {
    const fetchAppointment = async () => {
      try {
        ...
        console.log('Appointment object:', data.data);
        console.log('Patient object:', data.data?.patient);
        console.log('Patient.user object:', data.data?.patient?.user);
        console.log('Doctor object:', data.data?.doctor);
        console.log('Doctor.user object:', data.data?.doctor?.user);
  ...
  const patientName = patientUser?.fullName || appointment.patient?.fullName || 'Không rõ';
  ...
  const doctorName = doctorUser.fullName || doctor.fullName || 'Không rõ';
