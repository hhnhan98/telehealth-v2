...
const PatientProfile = () => {
  ...
  const handleSave = async () => {
    try {
      ...
      form.append('birthYear', profile.birthYear ?? profile.user.birthYear ?? '');
      form.append('address', profile.address || '');
      form.append('medicalHistory', profile.medicalHistory || '');
  ...
  return (
    <div style={{ maxWidth: '600px', margin: '20px auto', padding: '20px', border: '1px solid #ccc', borderRadius: '8px' }}>
      <h2 style={{ textAlign: 'center', marginBottom: '20px' }}>Thông tin bệnh nhân</h2>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '15px' }}>
        ...
        <div>
          ...
          <input type="number" name="birthYear" value={profile.birthYear ?? profile.user.birthYear ?? ''} onChange={handleChange} />
        </div>
        ...
        <div style={{ gridColumn: '1 / 3' }}>
          ...
          <textarea name="medicalHistory" value={profile.medicalHistory || ''} onChange={handleChange} rows={3} />
        </div>
        <div style={{ gridColumn: '1 / 3' }}>
          <label>Bio</label>
