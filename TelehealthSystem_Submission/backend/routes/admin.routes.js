...
// ================= Specialties =================
// Gộp tất cả và filter theo location vào 1 route duy nhất
router.get('/specialties', verifyToken, authorize('admin'), adminController.getSpecialties);
...
// ================= Statistics =================
router.get('/statistics', verifyToken, authorize('admin'), adminController.getStatistics);
