  ...
  return (
    <div className="flex h-screen bg-gray-100 overflow-hidden">
      ...
      <div className="flex-1 flex flex-col md:ml-48">
        {/* Header */}
        <header className="fixed top-0 left-0 md:left-48 right-0 h-16 bg-white border-b border-gray-200 flex items-center justify-between px-4 md:px-6 z-30 shadow-sm">
          <h3 className="text-lg font-semibold">Telehealth System</h3>
