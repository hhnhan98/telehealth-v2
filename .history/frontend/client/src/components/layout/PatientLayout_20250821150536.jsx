...
function PatientLayout() {
  ...
  return (
    <div className="flex min-h-screen bg-gray-100">
      {/* Sidebar desktop */}
      <aside className="hidden md:flex fixed top-0 left-0 h-full w-48 bg-white border-r border-gray-200 flex-col p-5 gap-2">
      ...
      <div className="flex-1 flex flex-col md:ml-48">
        {/* Header */}
        <header className="fixed top-0 left-0 md:left-48 right-0 h-16 bg-white border-b border-gray-200 flex items-center justify-between px-4 md:px-6 z-20">
