  ...
  return (
    <div className="layout-wrapper">
      <aside className="layout-sidebar">
        ...
        <button
          className={`layout-btn ${getActive('/dashboard') ? 'active' : ''}`}
          onClick={() => navigate('/patient/dashboard')}
        >
          Trang chủ
        </button>
        <button
          className={`layout-btn ${getActive('/patient/doctors') ? 'active' : ''}`}
          onClick={() => navigate('/patient/doctors')}
        >
          Danh sách bác sĩ
        </button>
        <button
          className={`layout-btn ${getActive('/book-appointment') ? 'active' : ''}`}
          onClick={() => navigate('/patient/book-appointment')}
        >
          Đặt lịch hẹn
        </button>
        <button
          className={`layout-btn ${getActive('/appointments') ? 'active' : ''}`}
          onClick={() => navigate('/patient/appointments')}
        >
          Lịch sử
        </button>
        <button
          className={`layout-btn ${getActive('/patient/profile') ? 'active' : ''}`}
