...
// import MedicalRecordList from './pages/patient/MedicalRecordList'; // Đang phát triển
...
// import CreateMedicalRecord from './pages/doctor/CreateMedicalRecord'; // Đang phát triển
  ...
  return (
    <Routes>
      ...
      <Route path="/doctor" element={<DoctorLayout />}>
        ...
        <Route path="medical-records" element={<MedicalRecordList />}           // Đang phát triển      
        <Route path="medical-records/create" element={<CreateMedicalRecord />}// Đang phát triển
