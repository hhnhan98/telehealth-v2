...
import PatientMedicalRecordDetail from './pages/doctor/PatientMedicalRecordDetail';
import PatientMedicalRecordList from './pages/doctor/PatientMedicalRecordList';
...
import DoctorMedicalRecordList from './pages/doctor/DoctorMedicalRecordList';
    ...
    <>
      <Routes>
        ...
        >
          ...
          <Route path="medical-records/:patientId" element={<DoctorMedicalRecordList />} />
          <Route path="appointments/:id" element={<DoctorAppo />} />
