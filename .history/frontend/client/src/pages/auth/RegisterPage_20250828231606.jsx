...
// Lọc specialty theo location đã chọn
const filteredSpecialties = formData.location
  ? specialties.filter(s => s.location?._id === formData.location)
  : [];
            ...
            {formData.role === 'doctor' && (
              <>
                ...
                >
                  ...
                  {selectedSpecialty?.location && (
                    <option value={selectedSpecialty.location._id}>
                      {selectedSpecialty.location.name}
                    </option>
                  )}
                </select>
              </>
