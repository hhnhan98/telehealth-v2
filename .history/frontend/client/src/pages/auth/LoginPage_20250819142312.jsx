...
// import ToastNotification nếu bạn đã có component toast
// import { AuthContext } from '../../context/AuthContext';

function LoginPage() {
  const navigate = useNavigate();
  // const { setUser } = useContext(AuthContext); // nếu dùng context
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Hoặc dùng toast: ToastNotification.show(err.message, 'error');
    } finally {
      setLoading(false);
    }
  };
