...
const RegisterPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // --- Chuẩn hóa payload: trim password & email
      const payload = {
      ...
      const loginRes = await authService.login({
        email: payload.email,       // đã trim + lowercase
        password: payload.password, // đã trim
      });
      ...
      console.log('[Login] Success, navigating for role:', loginRes.user.role);
