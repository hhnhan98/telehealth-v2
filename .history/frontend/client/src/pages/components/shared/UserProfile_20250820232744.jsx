...
const UserProfile = ({ currentUser, onProfileUpdate }) => {
  ...
  // Memoized components để tối ưu hiệu năng
  const CommonFields = useMemo(() => ({ formData, handleChange, isEditing }) => (
  ...
  // Các thành phần khác (DoctorFields, PatientFields, PasswordFields) cũng được memoize tương tự
    ...
    <div className="user-profile-card">
      ...
      {isEditing ? (
        <form className="profile-form" onSubmit={handleSubmit}>
          <CommonFields formData={formData} handleChange={handleChange} isEditing={isEditing} />
          
          {user.role === 'doctor' && <DoctorFields formData={formData} handleChange={handleChange} specialties={specialties} isEditing={isEditing} />}
          {user.role === 'patient' && <PatientFields formData={formData} handleChange={handleChange} isEditing={isEditing} />}
          
          <PasswordFields formData={formData} handleChange={handleChange} isEditing={isEditing} />
...
export default UserProfile;// import { useState, useEffect } from 'react';
// import userService from '../../../services/userService';
// import './UserProfile.css';
