...
const UserProfile = () => {
  ...
  const fetchUser = async () => {
    ...
    setError(null);
    try {
      const res = await axios.get('/users/me'); // axiosInstance đã tự thêm token
      setUser(res.data);
      setFormData({
  ...
  return (
    <div className="user-profile">
      ...
      <form className="profile-form" onSubmit={handleSubmit}>
        <label>
          Họ và têimport React, { useEffect, useState } from 'react';
import { fetchUserProfile, updateMyProfile } from '../../../services/api';
import './UserProfile.css';
