...
const UserProfile = ({ currentUser, onProfileUpdate }) => {
  ...
  const initializeFormData = useCallback((userData) => {
    return {
      ...
      // Thông tin bác sĩ
      specialtyId: userData?.specialtyId || userData?.specialty?._id || '',
  ...
  useEffect(() => {
    if (currentUser) {
      setUser(currentUser);
      setFormData(initializeFormData(currentUser));
    }
  }, [currentUser, initializeFormData]);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Gọi callback nếu có để thông báo cho component cha
      if (onProfileUpdate) {
      ...
      <div className="form-section">
        ...
        <div className="form-group">
          ...
          {isEditing ? (
            ...
            <div className="view-field">{formData.fullName || 'Chưa cập nhật'}</div>
          )}
        </div>
        ...
        <div className="form-row">
          <div className="form-group">
            ...
            {isEditing ? (
              ...
              <div className="view-field">{formData.phone || 'Chưa cập nhật'}</div>
            )}
          </div>
          ...
          <div className="form-group">
            ...
            {isEditing ? (
              ...
              <div className="view-field">{formData.birthYear || 'Chưa cập nhật'}</div>
            )}
          </div>
        </div>
        ...
        <div className="form-group">
          ...
          {isEditing ? (
            ...
            <div className="view-field">{formData.address || 'Chưa cập nhật'}</div>
          )}
        </div>
      </div>
    );
  }, [formData.fullName, formData.phone, formData.gender, formData.birthYear, formData.address, isEditing]);

  // Component cho thông tin bác sĩ
      ...
      <div className="form-section">
        ...
        <div className="form-group">
          ...
          {isEditing ? (
            ...
            <div className="view-field">
              {specialties.find(s => s._id === formData.specialtyId)?.name || 'Chưa cập nhật'}
            </div>
          )}
        </div>
        ...
        <div className="form-row">
          <div className="form-group">
            ...
            {isEditing ? (
              ...
              <div className="view-field">{formData.licenseNumber || 'Chưa cập nhật'}</div>
            )}
          </div>
          ...
          <div className="form-group">
            ...
            {isEditing ? (
              ...
              <div className="view-field">{formData.experience || 'Chưa cập nhật'}</div>
            )}
          </div>
        </div>
        ...
        <div className="form-group">
          ...
          {isEditing ? (
            ...
            <div className="view-field">{formData.education || 'Chưa cập nhật'}</div>
          )}
        </div>
        ...
        <div className="form-row">
          <div className="form-group">
            ...
            {isEditing ? (
              ...
              <div className="view-field">{formData.workingHours || 'Chưa cập nhật'}</div>
            )}
          </div>
          ...
          <div className="form-group">
            ...
            {isEditing ? (
              ...
              <div className="view-field">
                {formData.consultationFee ? `${parseInt(formData.consultationFee).toLocaleString('vi-VN')} VNĐ` : 'Chưa cập nhật'}
              </div>
            )}
          </div>
        </div>
        ...
        <div className="form-group">
          ...
          {isEditing ? (
            ...
            <div className="view-field" style={{whiteSpace: 'pre-wrap'}}>
  ...
  }, [formData.specialtyId, formData.licenseNumber, formData.experience, formData.education, 
      formData.workingHours, formData.consultationFee, formData.bio, specialties, isEditing]);
      ...
      <div className="form-section">
        ...
        <div className="form-row">
          <div className="form-group">
            ...
            {isEditing ? (
              ...
              <div className="view-field">{formData.emergencyContact || 'Chưa cập nhật'}</div>
            )}
          </div>
          ...
          <div className="form-group">
            ...
            {isEditing ? (
              ...
              <div className="view-field">{formData.emergencyPhone || 'Chưa cập nhật'}</div>
            )}
          </div>
          ...
          <div className="form-group">
            ...
            {isEditing ? (
              ...
              <div className="view-field">{formData.bloodType || 'Chưa cập nhật'}</div>
            )}
          </div>
        </div>
        ...
        <div className="form-group">
          ...
          {isEditing ? (
            ...
            <div className="view-field">{formData.allergies || 'Chưa cập nhật'}</div>
          )}
        </div>
        ...
        <div className="form-group">
          ...
          {isEditing ? (
            ...
            <div className="view-field" style={{whiteSpace: 'pre-wrap'}}>
              {formData.medicalHistory || 'Chưa cập nhật'}
            </div>
          )}
        </div>
        ...
        <div className="form-group">
          ...
          {isEditing ? (
            ...
            <div className="view-field">{formData.insurance || 'Chưa cập nhật'}</div>
          )}
        </div>
      </div>
    );
  }, [formData.emergencyContact, formData.emergencyPhone, formData.bloodType, 
      formData.allergies, formData.medicalHistory, formData.insurance, isEditing]);

  // Component cho thay đổi mật khẩu
  ...
  }, [formData.password, formData.confirmPassword, isEditing]);
    ...
    <div className="user-profile-card">
      ...
      {isEditing ? (
        <form className="profile-form" onSubmit={handleSubmit}>
          ...
          {user.role === 'doctor' && <DoctorFields isEditing={isEditing} />}
          {user.role === 'patient' && <PatientFields isEditing={isEditing} />}
          
          <PasswordFields isEditing={isEditing} />
...
// Các thành phần DoctorFields, PatientFields, PasswordFields được tách ra và memoize
// Định nghĩa các thành phần này tương tự như CommonFields
...
//       if (user.role === 'doctor') {
//         try {
//           // Assuming you have a service to fetch specialties
