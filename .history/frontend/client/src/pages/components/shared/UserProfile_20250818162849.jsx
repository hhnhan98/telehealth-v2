...
import axios from '../utils/axiosInstance'; // Hoặc file axios bạn dùng
import defaultAvatar from '../assets/default-avatar.png'; // file avatar mặc định
import './UserProfile.css'; // Tùy chỉnh CSS riêng nếu muốn
...
const UserProfile = () => {
  ...
  const fetchUser = async () => {
    ...
    setError(null);
    try {
      const token = localStorage.getItem('token'); // Hoặc state global
