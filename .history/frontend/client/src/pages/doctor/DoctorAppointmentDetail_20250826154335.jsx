      ...
      <Card>
        ...
        <div className="flex items-center space-x-4 mb-3">
          <img
            ...
            className="w-12 h-5 rounded-full border"
          />
          <div>
        ...
        {/* Bác sĩ */}
        <p className="mb-3"><strong>Bác sĩ:</strong> {doctorName}</p>
        ...
        <p>
          ...
          <span className={`px-2 py-1 rounded font-semibold ${statusColors[appointment.status] || ''}`}>
            {appointment.status}
          </span>
        </p>
      </Card>
