...
const DoctorDashboard = () => {
  ...
  // Giả lập fetch API (TODO: thay bằng API thật)
  useEffect(() => {
    setAppointments([
      {
        _id: "1",
  ...
  return (
    <div className="p-6">
      ...
      <div className="flex items-center justify-center gap-4 mb-8">
        <button
          onClick={handlePrev}
          className="px-3 py-1 border rounded-lg shadow-sm bg-gray-100 hover:bg-gray-200"
        >
          ◀
        </button>
        <input
      ...
      <div className="grid grid-cols-4 gap-4">
        {appointments.map((appt) => (
          <div
            key={appt._id}
            className={`p-4 rounded-xl shadow cursor-pointer text-center transition transform hover:scale-105 ${
              appt.status === "booked"
