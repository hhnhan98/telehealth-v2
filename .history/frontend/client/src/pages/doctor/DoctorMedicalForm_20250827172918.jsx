    ...
    <div className="medical-form-background">
      <Card className="medical-form-container">
        ...
        <Card className="section-card">
          ...
          <p><strong>Năm sinh:</strong> {appointment.patient.user.birthYear || 'Chưa cập nhật'}</p>
          <p><strong>Quê quán / Địa chỉ:</strong> {appointment.patient.address || 'Chưa cập nhật'}</p>
        </Card>
