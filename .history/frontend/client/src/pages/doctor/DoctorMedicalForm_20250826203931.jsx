    ...
    <Card className="section-card">
      ...
      <div className="form-row">
        <div className="form-group">
          ...
          <input
            name="fullName"
            value={form.fullName || appointment.patient.fullName}
        ...
        <div className="form-group">
          ...
          <input
            name="dob"
            type="date"
            value={form.dob || appointment.patient.dob}
            onChange={handleChange}
          />
        </div>
        <div className="form-group">
          ...
          <input
            name="gender"
            value={form.gender || appointment.patient.gender}
            onChange={handleChange}
          />
        </div>
        <div className="form-group">
          ...
          <input
            name="address"
            value={form.address || appointment.patient.address}
            onChange={handleChange}
          />
        </div>
        <div className="form-group">
          ...
          <input
            name="phone"
            value={form.phone || appointment.patient.phone}
            onChange={handleChange}
          />
        </div>
        <div className="form-group">
          ...
          <input
            name="idNumber"
            value={form.idNumber || appointment.patient.idNumber}
            onChange={handleChange}
          />
        </div>
        <div className="form-group">
          ...
          <input
            name="email"
            value={form.email || appointment.patient.email}
            onChange={handleChange}
          />
        </div>
      </div>
      ...
      <Card className="section-card">
        ...
        {form.prescriptions.map((p, idx) => (
          <div key={idx} className="prescription-row two-columns">
            {['name','dose','quantity','unit','note'].map(field => (
