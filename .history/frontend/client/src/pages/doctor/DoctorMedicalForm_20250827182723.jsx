    ...
    <div className="medical-form-background">
      <Card className="medical-form-container">
        ...
        <Card className="section-card">
          ...
          <p><strong>Họ tên:</strong> {appointment.patient?.fullName || 'Đang cập nhật'}</p>
          <p><strong>Năm sinh:</strong> {appointment.patient?.birthYear || 'Đang cập nhật'}</p>
          <p><strong>Quê quán:</strong> {appointment.patient?.address || 'Đang cập nhật'}</p>
        </Card>
