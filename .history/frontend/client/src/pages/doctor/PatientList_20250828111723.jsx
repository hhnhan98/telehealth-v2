// ===== DANH SÁCH BỆNH NHÂN BÁC SĨ TỪNG KHÁM =====
...
{selectedPatient && (
  <DoctorMedicalRecordList
    ...
    onRecordSaved={(newRecord) => {
      // Khi cần cập nhật danh sách tổng thể, ví dụ cập nhật state patients
      // hoặc chỉ cần reload records trong DoctorMedicalRecordList thì có thể bỏ qua
