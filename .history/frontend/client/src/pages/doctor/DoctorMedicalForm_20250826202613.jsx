          ...
          <Card className="section-card">
            ...
            {form.prescriptions.map((p, idx) => (
              <div key={idx} className="prescription-row">
                ...
                placeholder="Số lượng" value={p.quantity} onChange={e => handlePrescriptionChange(idx,'quantity',e.target.value)} className={formErrors[`prescription-quantity-${idx}`] ? 'error-input' : ''}/>
