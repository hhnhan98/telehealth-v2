...
// Sau khi kiểm tra appointment !== null
const patient = appointment.patient || {};
const patientUser = patient.user || {};
const patientfullName = patientUser?.fullName || appointment.patient?.fullName || 'Không rõ';
const patientEmail = patientUser.email || patient.email || 'Không rõ';
const patientPhone = patientUser.phone || patient.phone || 'Không rõ';
const patientAvatar = patientUser.avatar || patient.avatar || '/default-avatar.png';
