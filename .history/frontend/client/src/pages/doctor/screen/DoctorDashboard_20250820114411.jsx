...
import { fetchDoctorDashboard } from '../../../services/bookingService'; // Hoặc dashboardService
...
const DoctorDashboard = () => {
  ...
  const loadDashboard = useCallback(async () => {
    try {
      ...
      const todayAppts = res.todayAppointments || [];
      setTodayAppointments(todayAppts);
      setTodayAppointmentsCount(todayAppts.length);
      setWeeklyAppointmentsCount(res.weeklyAppointmentsCount || 0);
      setError(null);
    } catch (err) {
