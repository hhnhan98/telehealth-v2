...
import axios from '../../../utils/axios'; // Đảm bảo file utils/axios.js tồn tại với baseURL
                ...
                <tr key={day.date}>
                  ...
                  <td>
                    {day.appointments.length===0 ? 'Không có' : day.appointments.map(a => (
                      <div key={a._id}>
                        {new Date(a.date).toLocaleTimeString([], {hour:'2-digit', minute:'2-digit'})} - {a.patient?.fullName}
                        {' '}
