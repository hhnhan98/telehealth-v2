  ...
  return (
    <div>
      ...
      <div style={{ marginBottom: '16px' }}>
        <button onClick={() => setViewType('day')}>Hôm nay</button>
        <button onClick={() => setViewType('week')} style={{ marginLeft: 8 }}>Cả tuần</button>
      </div>
        ...
        <ul className="schedule-list">
          {appointments.map((appt) => (
            <li key={appt._id} className="schedule-item">
              <strong>{new Date(appt.date).toLocaleString('vi-VN', {
                hour: '2-digit',
                minute: '2-digit',
                day: '2-digit',
                month: '2-digit',
