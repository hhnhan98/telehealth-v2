...
[{
	"resource": "/b:/telehealth-v2/frontend/client/src/pages/admin/AdminDashboard.jsx",
	"owner": "eslint4",
	"severity": 8,
	"message": "Parsing error: Unexpected reserved word 'await'. (51:20)",
	"source": "eslint",
	"startLineNumber": 51,
	"startColumn": 20,
	"endLineNumber": 51,
      ...
      >
        <form onSubmit={handleSubmit}>
          {editType && formFields[editType].map(f=>{
            ...
            if(f.type==='select') {
              // Nếu doctor, filter specialty theo location
