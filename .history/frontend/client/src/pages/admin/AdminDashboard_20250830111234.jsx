      ...
      <div className="admin-section">
        ...
        <table className="statistics-table">
          <tbody>
            <tr>
              <th>Locations</th>
              <td>{statistics.locations}</td>
            </tr>
            <tr>
              <th>Specialties</th>
              <td>{statistics.specialties}</td>
            </tr>
            <tr>
              <th>Doctors</th>
              <td>{statistics.doctors}</td>
            </tr>
            <tr>
              <th>Patients</th>
              <td>{statistics.patients}</td>
            </tr>
            <tr>
              <th>Schedules</th>
              <td>{statistics.schedules}</td>
            </tr>
            <tr>
              <th>Appointments</th>
              <td>{statistics.appointments}</td>
            </tr>
            <tr>
              <th>Medical Records</th>
              <td>{statistics.medicalRecords}</td>
            </tr>
            <tr>
