  ...
  const handleChange = async e => {
    ...
    if (name === 'location' && value) {
      try {
        ...
        // Kiểm tra specialty hiện tại
        if (form.specialty && !res.data.data.find(s => s._id === form.specialty)) {
          alert('Specialty hiện tại không thuộc location đã chọn. Vui lòng chọn lại.');
