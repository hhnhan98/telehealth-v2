      ...
      {loading ? <p>Đang tải...</p> :
        ...
        {appointments.map(appt => (
          <div className="appointment-card" key={appt._id}>
            <div className="appt-row"><span>Thời gian:</span> {formatTime(appt.datetime)}</div>
            <div className="appt-row"><span>Cơ sở:</span> {appt.location?.name || '-'}</div>
            <div className="appt-row"><span>Chuyên khoa:</span> {appt.specialty?.name || '-'}</div>
            <div className="appt-row"><span>Bác sĩ:</span> {appt.doctor?.fullName || '-'}</div>
            <div className="appt-row"><span>Lý do khám:</span> {appt.reason || '-'}</div>
            <div className="appt-row"><span>Trạng thái:</span> {renderStatus(appt.status)}</div>
