              ...
              {appointments.map(appt => (
                <div key={appt._id} className="appointment-card">
                  ...
                  <div className="appt-body">
                    <p><strong>Cơ sở:</strong> {appt.location?.name || '-'}</p>
                    <p><strong>Chuyên khoa:</strong> {appt.specialty?.name || '-'}</p>
                    <p><strong>Bác sĩ:</strong> {appt.doctor?.fullName || '-'}</p>
                  ...
                  <div className="appt-actions">
                    {appt.status === 'pending' && (
                      <div className="otp-container">
                        ...
                        {otpStatus[appt._id] === 'success' && <span className="success-text">✓</span>}
                        {otpStatus[appt._id] === 'error' && <span className="error-text">✗</span>}
                      </div>
                    )}
