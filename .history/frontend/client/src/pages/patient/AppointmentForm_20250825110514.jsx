        ...
        <form className="appointment-form-grid" onSubmit={handleSubmit}>
          <div className="form-section card">
            ...
            <div className="form-group">
              ...
              <input type="date" value={bookingData.date} min={today} 
                                  onChange={e => setBookingData(prev => ({ ...prev, date: e.target.value }))} disabled={!bookingData.doctor} />
            </div>
              ...
              >
                ...
                {availableTimes.map((slot, index) => (
                  <option key={`${slot.time}-${index}`} value={slot.time}>
                    {formatVN(slot.datetimeVN, 'HH:mm')}
                  </option>
                ))}
              </select>
            </div>
