...
function BookAppointment() {
  ...
  useEffect(() => {
    const fetchDoctors = async () => {
      ...
      try {
        const res = await axios.get(`/api/users/doctors?specialty=${selectedSpecialty}`);
        setDoctors(res.data || []);
      } catch (error) {
    ...
    <div style={{ padding: '20px', maxWidth: '700px', margin: '0 auto' }}>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div style={{ marginBottom: '16px' }}>
          ...
          <select value={doctor} onChange={(e) => setDoctor(e.target.value)} style={{ width: '100%', padding: '8px' }} disabled={!specialty}>
        ...
        <div style={{ marginBottom: '16px' }}>
          ...
          <input type="date" value={date} onChange={(e) => setDate(e.target.value)} style={{ padding: '8px', marginRight: '12px' }} />
