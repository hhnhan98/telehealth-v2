...
const AppointmentForm = ({ currentUser }) => {
  ...
  const loadSpecialties = useCallback(async () => {
    ...
    try {
      ...
      const list = Array.isArray(res.data?.data?.specialties) ? res.data.data.specialties : [];
      setSpecialties(list);
  ...
  const loadDoctors = useCallback(async () => {
    ...
    try {
      ...
      const list = Array.isArray(res.data?.data?.doctors) ? res.data.data.doctors : [];
      setDoctors(list);
  ...
  const loadAvailableSlots = useCallback(async () => {
    ...
    try {
      ...
      const list = Array.isArray(res.data?.data?.availableSlots) ? res.data.data.availableSlots : [];
