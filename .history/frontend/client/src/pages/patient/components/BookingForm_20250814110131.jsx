...
const BookingForm = ({ currentUser }) => {
  ...
  // Khi chọn chuyên khoa → load bác sĩ theo location + specialty
  useEffect(() => {
  ...
  return (
    <div className="booking-form">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <input type="text" name="fullName" placeholder="Họ tên" value={bookingData.patient.fullName} onChange={handlePatientChange} required disabled={!bookingData.time} />
        <select name="gender" value={bookingData.patient.gender} onChange={handlePatientChange} required disabled={!bookingData.time}>
          <option value="">Giới tính</option>
          <option value="male">Nam</option>
          <option value="female">Nữ</option>
        </select>
        <input type="date" name="dob" value={bookingData.patient.dob} onChange={handlePatientChange} required disabled={!bookingData.time} />
        <input type="text" name="phone" placeholder="Số điện thoại" value={bookingData.patient.phone} onChange={handlePatientChange} disabled={!bookingData.time} />
        <input type="email" name="email" placeholder="Email" value={bookingData.patient.email} onChange={handlePatientChange} disabled={!bookingData.time} />
        <textarea name="reason" placeholder="Lý do khám" value={bookingData.patient.reason} onChange={handlePatientChange} disabled={!bookingData.time} />
