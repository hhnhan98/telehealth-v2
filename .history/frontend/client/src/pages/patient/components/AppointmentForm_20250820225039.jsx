...
export default AppointmentForm;// // src/components/booking/AppointmentForm.jsx
// import React, { useState, useEffect, useCallback, useRef } from 'react';
// import bookingService from '../../../services/bookingService';
// import './AppointmentForm.css';
...
//       // // Thêm debug logging để xem structure response
//       // console.log('DEBUG createAppointment response:', res);
//       // console.log('res.appointment:', res?.appointment);
//       // console.log('res.data:', res?.data);
//       // console.log('Full response structure:', JSON.stringify(res, null, 2));      
      
//       // // Thử các path khác nhau
//       // const appointmentId = res?.appointment?._id || res?.data?.appointment?._id || res?.data?._id || res?._id;
