...
const AppointmentForm = ({ currentUser }) => {
  ...
  // Prefill patient info nếu có user đăng nhập
  useEffect(() => {
    if (currentUser) {
      setBookingData(prev => ({
        ...prev,
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const payload = {
        ...
        patientId: currentUser?._id, // nếu có đăng nhập
        patient: currentUser ? undefined : bookingData.patient // nếu chưa đăng nhập
      };
