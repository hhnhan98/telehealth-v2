...
const AppointmentForm = () => {
  ...
  useEffect(() => {
    ...
    const loadSpecialties = async () => {
      ...
      const filtered = list.filter((spec) => spec.locations.includes(bookingData.location));
      setSpecialties(filtered);
      specialtiesCache.current[bookingData.location] = filtered;
    };
