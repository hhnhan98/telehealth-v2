...
const AppointmentForm = ({ currentUser }) => {
  ...
  const handleSubmit = async e => {
    ...
    try {
      const { location, specialty, doctor, date, time, patient } = bookingData;
      const res = await axios.post('/appointments/create', { location, specialty, doctor, date, time, patient });
  ...
  const handleVerifyOtp = async () => {
    ...
    setLoading(true);
    try {
      await axios.post('/appointments/verify-otp', { appointmentId: createdAppointmentId, otp: otpInput });
      ...
      setBookingData({
        ...
        date: '',
        time: '',
        patient: currentUser ? { ...bookingData.patient, reason: '' } : {
          fullName: '',
          gender: '',
          dob: '',
          phone: '',
