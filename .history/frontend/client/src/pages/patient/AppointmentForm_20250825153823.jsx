    ...
    <div className="appointment-form-container">
      ...
      {!otpStage ? (
          ...
          <div className="form-section card">
            ...
            <div className="form-group">
              ...
              <select
                ...
                onChange={e => setBookingData(prev => ({ ...prev, specialty: e.target.value }))}
              >
                <option value="">Chọn chuyên khoa</option>
                {specialties.map(sp => <option key={sp._id} value={sp._id}>{sp.name}</option>)}
              </select>
            </div>
            ...
            <div className="form-group">
              ...
              <select
                ...
                disabled={loadingSlots || !availableTimes.length}
              >
                <option value="">{loadingSlots ? 'Đang tải...' : 'Chọn giờ khám'}</option>
        ...
        <div className="otp-verification card">
          <h3>Xác thực OTP</h3>
          <p>Nhập mã OTP đã gửi email của bạn.</p>
          ...
          <p>Thời gian còn lại: {formatTimer(otpTimer)}</p>
