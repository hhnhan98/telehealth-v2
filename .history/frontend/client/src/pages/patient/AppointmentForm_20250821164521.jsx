...
const AppointmentForm = ({ currentUser }) => {
  ...
  return (
    <div className="appointment-form-container">
      <h2 className="form-title">Vui lòng nhập thông tin lịch hẹn</h2>
      ...
      {!otpStage ? (
        <form className="appointment-form-grid" onSubmit={handleSubmit}>
          ...
          <div className="form-section card">
            <h3 className="section-title">Thông tin lịch khám</h2>
            <h4 className="section-title">Triệu chứng / Lý do khám</h4>
            <div className="form-group">
