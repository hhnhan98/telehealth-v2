// src/pages/patient/AppointmentList.jsx
            ...
            <tbody>
              {appointments.map(appt => (
                <tr key={appt._id}>
                  ...
                  <td>
                    <button onClick={() => navigate(`/patient/appointments/${appt._id}`)}>
                      Xem chi tiết
                    </button>
                  </td>
                </tr>
...
//     console.log('DEBUG verify OTP payload:', { appointmentId: id, otp });
