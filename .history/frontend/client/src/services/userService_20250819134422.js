...
export const fetchUserProfile = async () => {
  try {
    ...
    if (res.data.success) return res.data.data || res.data.user || {};
    throw new Error(res.data.message || 'Fetch user failed');
  } catch (err) {
...
export const fetchAllUsers = async (queryParams = {}) => {
  try {
    ...
    if (res.data.success) return res.data.data || res.data.users || [];
    throw new Error(res.data.message || 'Fetch all users failed');
  } catch (err) {
...
export const fetchDoctorsBySpecialty = async (specialty) => {
  ...
  try {
    ...
    if (res.data.success) return res.data.data || res.data.doctors || [];
    throw new Error(res.data.message || 'Fetch doctors by specialty failed');
  } catch (err) {
