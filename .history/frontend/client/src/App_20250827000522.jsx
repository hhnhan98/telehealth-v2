...
import WockSchedule from './pages/doctor/WockSchedule';
import PatientList from './pages/doctor/commingsoon/PatientList';
import MedicalRecordList from './pages/doctor/commingsoon/MedicalRecordList';
import AppointmentDetailDoctor from './pages/doctor/AppointmentDetail';
    ...
    <>
      <Routes>
        ...
        >
          ...
          <Route path="schedule" element={<WockSchedule />} />
          <Route path="patients" element={<PatientList />} />
          {/* Modal vẫn mở từ PatientList, nhưng route trực tiếp cũng có thể truy cập */}
          <Route path="medical-records/:patientId" element={<MedicalRecordList />} />
