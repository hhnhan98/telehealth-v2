...
Các script seed (seedFulldata.js và seedAdmin.js) đã chuẩn bị dữ liệu demo đầy đủ, expireAppointment.js được tích hợp vào index.js auto chạy mỗi khi chạy backend