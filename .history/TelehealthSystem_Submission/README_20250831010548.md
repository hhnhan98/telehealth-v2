...
Các script seed (seedFulldata.js và seedAdmin.js) đã chuẩn bị dữ liệu demo đầy đủ, expireAppointment.js được tích hợp trong index.js sẽ auto chạy khi chạy backend