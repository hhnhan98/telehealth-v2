...
Các script seed (seedFulldata.js và seedAdmin.js) đã chuẩn bị dữ liệu demo đầy đủ, script expireAppointment.js được viết trong index.js sẽ auto chạy khi chạy backend