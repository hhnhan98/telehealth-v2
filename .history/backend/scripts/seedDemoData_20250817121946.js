...
const WORK_HOURS = ["08:00","08:30","09:00","09:30","10:00","10:30","11:00",
...
async function seedDemoData() {
  try {
    ...
    const appointments = [];
    const usedSlots = {}; // key = doctorId_date_time
    ...
    for (let patient of patientUsers) {
      ...
      while(count < 5){
        ...
        // Random ngày trong khoảng 3 ngày trước và 3 ngày sau hôm nay
        ...
        appointments.push({
          ...
          status,
          isVerified: status !== "pending" // pending chưa verify
        });
