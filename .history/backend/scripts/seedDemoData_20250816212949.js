...
async function seedDemoData() {
  try {
    ...
    for (let i = 1; i <= 3; i++) {
      ...
      console.log(`>>> Tài khoản bác sĩ: email=${patient.email}, password=123456`);
    ...
    for (let i = 1; i <= 3; i++) {
      ...
      console.log(`>>> Tài khoản bệnh nhân: email=${patient.email}, password=123456`);
    }

    // --- Tạo lịch hẹn demo cho mỗi bệnh nhân ---
    const demoStatuses = ['pending', 'confirmed', 'confirmed', 'pending', 'confirmed'];
