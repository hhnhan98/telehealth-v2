...
async function seedDemoData() {
  ...
  // Gán ngẫu nhiên 2–3 chuyên khoa cho mỗi cơ sở
  ...
  // --- Seed Doctors ---
  const doctorsData = [
    { fullName: 'Dr. A', email: 'doca@demo.com', phone: '09000001' },
    { fullName: 'Dr. B', email: 'docb@demo.com', phone: '09000002' },
    { fullName: 'Dr. C', email: 'docc@demo.com', phone: '09000003' },
    { fullName: 'Dr. D', email: 'docd@demo.com', phone: '09000004' },
  ];
  ...
  // --- Seed Patients demo ---
  const patientsData = [
    { fullName: 'Patient 1', email: 'patient1@demo.com', phone: '0901000001' },
    { fullName: 'Patient 2', email: 'patient2@demo.com', phone: '0901000002' },
  ];
