...
const DEFAULT_SLOTS = ['08:30', '09:30', '10:30', '13:00', '14:00', '15:00', '16:00', '16:30'];
const APPOINTMENT_STATUSES = ['cancelled', 'pending', 'confirmed'];

if (process.argv.length < 4) {
  console.log('❌ Vui lòng cung cấp doctorId và patientId');
  process.exit(1);
}
