...
async function seedDemoData() {
  try {
    ...
    // ===== 4. Gán Doctor (tham chiếu Location, Specialty) =====
    const doctors = await Doctor.insertMany([
      { fullName: doctorUsers[0].fullName, specialties: [specialties[0]._id, specialties[1]._id], location: locations[0]._id },
      { fullName: doctorUsers[1].fullName, specialties: [specialties[1]._id, specialties[2]._id], location: locations[1]._id },
      { fullName: doctorUsers[2].fullName, specialties: [specialties[0]._id, specialties[2]._id], location: locations[2]._id },
    ]);
