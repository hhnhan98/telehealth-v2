...
async function seedDemoData() {
  try {
    ...
    // --- Users ---
    const admin = await User.create({ fullName: 'Admin Demo', email: 'admin@telehealth.com', password: '123456', role: 'admin' });
    const patientUser = await User.create({ fullName: 'Patient Demo', email: 'patient@telehealth.com', password: '123456', role: 'patient' });
