...
const patientController = require('../controllers/patient.controller'); // ✅ thêm
...
router.get('/:patientId/medical-records', authDoctor, patientController.getMedicalRecordsByPatient);
