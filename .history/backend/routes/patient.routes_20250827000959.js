...
const { getMyPatients, getMedicalRecordsByPatient } = require('../controllers/patient.controller');
...
router.get('/my-patients', verifyToken, isDoctor, patientController.getPatientsByDoctor);
router.get('/:patientId/medical-records', verifyToken, getMedicalRecordsByPatient);
