...
router.post('/', verifyToken, async (req, res) => {
  try {
    ...
    const appointmentDate = new Date(
      year, parseInt(month) - 1, parseInt(day),
    ...
    res.status(201).json({ message: 'Tạo lịch hẹn thành công', appointment: populated });
  } catch (err) {
...
/**
 * Cập nhật lịch hẹn (chỉ bệnh nhân đã đặt)
 */
...
/**
 * Hủy lịch hẹn (chỉ bệnh nhân đã đặt)
 */
...
/**
 * Xóa lịch hẹn (chỉ bệnh nhân đã đặt)
 */
