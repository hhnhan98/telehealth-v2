...
const getLocations = async (req, res) => {
  try {
    ...
    console.error(err);
    return responseError(res, 'Lỗi khi lấy danh sách cơ sở', 500);
  }
};
...
const getSpecialtiesByLocation = async (req, res) => {
  try {
    ...
    console.error(err);
    return responseError(res, 'Lỗi khi lấy danh sách chuyên khoa', 500);
  }
};
...
const getDoctorsBySpecialtyAndLocation = async (req, res) => {
  try {
    ...
    if (!specialtyId || !locationId)
      return responseError(res, 'Thiếu thông tin specialtyId hoặc locationId');
    ...
    console.error(err);
    return responseError(res, 'Lỗi khi lấy danh sách bác sĩ', 500);
  }
};
...
const getAvailableSlots = async (req, res) => {
  try {
    ...
    if (date < today) return responseError(res, 'Không thể lấy slot quá khứ');
    ...
    console.error(err);
    return responseError(res, 'Lỗi khi lấy khung giờ trống', 500);
  }
};
...
const createAppointment = async (req, res) => {
  try {
    ...
    console.error(err);
    return responseError(res, 'Lỗi tạo lịch hẹn', 500);
  }
};
...
const getAppointments = async (req, res) => {
  try {
    ...
    console.error(err);
    return responseError(res, 'Lỗi khi lấy lịch hẹn', 500);
  }
};
...
const verifyOtp = async (req, res) => {
  try {
    ...
    console.error(err);
    return responseError(res, 'Lỗi xác thực OTP', 500);
  }
};
...
const resendOtpController = async (req, res) => {
  try {
    ...
    console.error(err);
    return responseError(res, 'Lỗi gửi lại OTP', 500);
  }
};
...
const cancelAppointment = async (req, res) => {
  try {
    ...
    console.error(err);
    return responseError(res, 'Lỗi khi hủy lịch hẹn', 500);
  }
};
