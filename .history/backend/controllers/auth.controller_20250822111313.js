...
exports.register = async (req, res) => {
  try {
    ...
    console.log('[Register] chuẩn bị tạo Patient document cho userId:', newUser._id);
    ...
    if (role === 'patient') {
      try {
        ...
        if (!existingPatient) {
          ...
          console.log(`>>> Patient document đã tồn tại cho ${newUser.fullName}`);
        }
      } catch (err) {
        console.error('*** Tạo Patient document thất bại ', err);
      }
    }
