...
exports.getAllLocations = async (req, res) => {
  try {
    const locations = await Location.find().populate('doctors', 'user specialty').populate('specialties', 'name');
...
exports.getAllSpecialties = async (req, res) => {
  try {
    const specialties = await Specialty.find().populate('location', 'name').populate('doctors', 'user');
