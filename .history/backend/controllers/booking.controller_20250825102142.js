...
const getAppointmentById = async (req, res) => {
  try {
    ...
    if (!appointment) {
      return responseError(res, 'Không tìm thấy lịch hẹn', 404);
    }

    // Chỉ cho phép bệnh nhân của lịch này xem chi tiết
    if (appointment.patient.toString() !== patientId.toString()) {
      return responseError(res, 'Không có quyền xem lịch hẹn này', 403);
    }
