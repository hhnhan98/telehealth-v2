...
const Schedule = require('../models/Schedule'); // cần để lấy slot trống
...
const getDashboardData = async (req, res) => {
  try {
    ...
    if (!doctor) {
      console.log('⚠ Không tìm thấy Doctor cho user này');
    ...
    console.log('📌 Today VN:', todayVN.format(), 'UTC range:', todayStartUTC, '-', todayEndUTC);
    ...
    console.log('📌 Today Appointments fetched:', todayAppointments.length);
    ...
    console.log('📌 Schedule totalSlots:', totalSlots, 'bookedSlots:', bookedSlots);
    ...
    // --- Log dashboard data trước khi gửi ---
