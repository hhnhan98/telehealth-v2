...
exports.getUserById = async (req, res) => {
  try {
    ...
    return responseSuccess(res, 'Thông tin người dùng', { user });
  } catch (err) {
...
exports.updateUser = async (req, res) => {
  try {
    ...
    if (!updatedUser) return responseError(res, 'Không tìm thấy người dùng', 404);
    return responseSuccess(res, 'Cập nhật thành công', { user: updatedUser });
  } catch (err) {
...
exports.updateMyProfile = async (req, res) => {
  try {
    ...
    await user.save();
    return responseSuccess(res, 'Cập nhật hồ sơ thành công', { user: user.toJSON() });
  } catch (err) {
...
exports.deleteUser = async (req, res) => {
  try {
    ...
    if (!deletedUser) return responseError(res, 'Không tìm thấy người dùng', 404);
    return responseSuccess(res, 'Đã xoá user', { userId: deletedUser._id });
  } catch (err) {
