...
if (role === 'doctor') {
  ...
  if (specialtyDoc && !specialtyDoc.doctors.includes(newUser._id)) {
  ...
  if (locationDoc && !locationDoc.doctors.includes(newUser._id)) {
    locationDoc.doctors.push(newUser._id);
    await locationDoc.save();
  }
}

    //onsole.log('[Register] Sau khi save - Password hashed:', newUser.password);
